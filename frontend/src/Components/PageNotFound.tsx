...
function PageNotFound() {
  return (
    <section className="flex items-center h-full p-16 font-open">
      <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
        <div className="max-w-md text-center">
          ...
          <Link to="/">
           <button className='px-8 py-3 font-semibold rounded border border-white text-white'>Back to homepage</button>
          </Link>
        </div>
      </div>
    </section>
